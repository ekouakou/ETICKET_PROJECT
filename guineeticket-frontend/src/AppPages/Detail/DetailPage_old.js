...
function Detail() {
  ...
  const handlePayment = async () => {
    ...
    try {
      ...
      // Ouvrir l'URL de paiement si c'est Orange Money
      if (selectedOption === 1) {
        window.open(payment_url, "_blank");
      }

      // Démarrer le monitoring du paiement
                                    ...
                                    <div className=" bgi-no-repeat bgi-position-center bgi-size-cover card-rounded w-100">
                                      <div className="row mb-10">
                                        <div className="col-xl-3 col-lg-4 col-md-4 col-xs-12 col-12 d-flex flex-column h-100 mb-4">
                                          <label
                                            className={`btn btn-outline btn-outline-dashed d-flex text-start p-6 ${selectedGetitcketOption === 1
                                        ...
                                        <div className="col-xl-3 col-lg-4 col-md-4 col-xs-12 col-12 d-flex flex-column mb-4">
                                          <label
                                            className={`btn btn-outline btn-outline-dashed d-flex text-start p-6 ${selectedGetitcketOption === 2
                                              ? "btn-active-light-primary active"
                                              : " "
                                              }`}
                                            data-kt-button="true"
                                        ...
                                        <div className="col-xl-3 col-lg-4 col-md-4 col-xs-12 col-12 d-flex flex-column mb-4">
                                          <label
                                            className={`btn btn-outline btn-outline-dashed d-flex text-start p-6 ${selectedGetitcketOption === 3
                                              ? "btn-active-light-primary active"
                                              : " "
                                              }`}
                                            data-kt-button="true"
