...
const MyAcount = () => {
  ...
  const generateWhatsAppLink = () => {
    ...
    const ticketUrl = encodeURIComponent(
      "http://guineeticket.com/?id=" + ticketName
    ); // Ou un lien direct vers l'affichage du ticket en ligne
                    ...
                    <div className="plan plan--active">
                      ...
                      <ul className="plan__list">
                        ...
                        <li className="plan__item plan__item--none">
                          <i className="ti ti-circle-minus" /> Limited
                          Availability
                        </li>
                        <li className="plan__item plan__item--none">
                  ...
                  <div className="col-12 col-md-12 col-lg-4 order-md-1 order-lg-2">
                    <div className="plan plan--orange">
                      ...
                      <ul className="plan__list">
                        ...
                        <li className="plan__item">
                          <i className="ti ti-circle-check" /> Limited
                          Availability
                        </li>
                        <li className="plan__item plan__item--none">
                  ...
                  <div className="col-6 col-sm-4 col-lg-3 col-xl-2">
                    <div className="item">
                      <div className="item__cover">
                        ...
                        <span className="item__rate item__rate--yellow">
                          6.9
                        </span>
                        <button
                          className="item__favorite item__favorite--active"
