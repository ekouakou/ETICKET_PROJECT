              ...
              <Spin spinning={fetchLoading || postLoading} tip="Chargement des données...">
                ...
                <Row gutter={[16, 16]} className="mt-4">
                  {allEventsData && allEventsData.map(event => (
                    <Col xs={24} sm={12} md={8} lg={6} key={event.LG_EVEID} className="mb-4">
                      <Card
                        hoverable
                        cover={
                        ...
                        <Meta
                          ...
                          description={
                            <div>
                              ...
                              <p className="mb-1 mt-0"><strong>Téléphone:</strong> {event.STR_TICPHONE} </p>

                              {/* <StatusTag status={event.STR_EVESTATUT} /> */}
                            </div>
                          }
                        />
                      </Card>
