...
const DetailClient = () => {
    ...
    const fetchEvents = async () => {
        try {
            const events = await ClientService.getClientTickets(navigate);
    ...
    useEffect(() => {
        if (utilisateurId) {  // On s'assure d'avoir l'ID de l'utilisateur
            fetchEvents();
        }
                                            ...
                                            <div className="row g-xxl-3">
                                                <div className="tab-content px-3">
                                                    <div
                                                        ...
                                                        role="tabpanel"
                                                        aria-labelledby="kt_security_summary_tab_hours_agents"
                                                    >
