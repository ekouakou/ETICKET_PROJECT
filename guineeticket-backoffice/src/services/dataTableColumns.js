    ...
    },
    {
      ...
      render: (categories) =>
        ...
        categories.map((cat, index) => (
          <div key={index}>
            <small>
              {cat.STR_LSTDESCRPTION}: {cat.DBL_ELIAMOUNT}{" "}
              {process.env.REACT_APP_DEVISE}
            </small>
      ...
      render: (_, record) => (
        <Space>
          ...
          <Button
            ...
            onClick={() =>
              handleToggleStatus(record.LG_EVEID, record.STR_EVESTATUT)
            }
            size="small"
          />
        </Space>
...
export const getTypeActiviteColumns = (
  handleEdit,
  handleDeleteItem,
  handleToggleStatus,
  baseImageUrl
  ...
  return [
    {
      title: "Activités",
      dataIndex: "STR_LSTDESCRIPTION",
      key: "name",
      width: 200,
    },
    {
      title: "Catégorie",
      dataIndex: "STR_LSTOTHERVALUE",
      key: "name",
      width: 200,
    },
    {
...
export const getCategoriePlaceColumns = (
  handleEdit,
  handleDeleteItem,
  handleToggleStatus,
  baseImageUrl
      ...
      render: (_, record) => (
        <Space>
          ...
          <Button
            ...
            onClick={() =>
              handleToggleStatus(record.LG_PROID, record.STR_EVESTATUT)
            }
            size="small"
          />
        </Space>
